				...
				<table class="table">
					<thead>
						...
						<th style="padding: 0px;">
							...
							<!-- <a href="{{ route('dashboard.lagnas.create') }}" class="btn btn-primary pull-right" target="_blank" style="margin-top: 3px;">
								Add new
							</a> -->
						</th>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<!-- <a href="{{ route('dashboard.lagnas.edit', $resource->id) }}" class="btn btn-primary pull-left" style="margin-right:5px;"><i class="fa fa-edit"></i></a> -->
								{{ Form::open(['route' => ['dashboard.lagnas.destroy', $resource->id] , 'method' => 'DELETE']) }}
