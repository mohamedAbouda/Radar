...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            {{ Form::open(['route' => 'dashboard.carmodels.store' , 'files' => true]) }}
            <div class="row">
                <div class="col-md-12">
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="col-md-12">
                            ...
                            <label for="pic">
                                <img src="{{ asset('/img/gall-img-1.jpg') }}" alt="" class="thumbnail" style="width:215px;height:215px;cursor: pointer; cursor: hand;">
